    ...
    HANDLERS = [
        ...
        (r'/astroph-coffee/search',coffeehandlers.FTSHandler,
 	    ...
 	    (r'/astroph-coffee/calendar',coffeehandlers.CalendarHandler,
          ...
          'department':COFFEE_DEPARTMENT,
          'institution':COFFEE_INSTITUTION}),
      (r'/astroph-coffee/discussed',coffeehandlers.DiscussedHandler,
          {'database':DATABASE,
          'voting_start':VOTING_START,
          'voting_end':VOTING_END,
          'coffee_time':COFFEE_TIME,
          ...
          'department':COFFEE_DEPARTMENT,
          'institution':COFFEE_INSTITUTION}),
        (r'/astroph-coffee/local-papers', coffeehandlers.LocalArchiveHandler,
         {'database': DATABASE,
          'display': False,
          'voting_start':VOTING_START,
          'voting_end':VOTING_END,
          ...
          'department':COFFEE_DEPARTMENT,
          'institution':COFFEE_INSTITUTION,}),
        (r'/astroph-coffee/local-display', coffeehandlers.LocalArchiveHandler,
         {'database': DATABASE,
          'display':True,
          'voting_start':VOTING_START,
          'voting_end':VOTING_END,
